...
class RootViewModel {
  ...
  constructor() {
    ...
    const navData = [
      ...
      { path: "dashboard", detail: { label: "Login", iconClass: "oj-ux-ico-bar-chart" } },
      { path: "incidents", detail: { label: "Register", iconClass: "oj-ux-ico-fire" } },
      { path: "customers", detail: { label: "Admin", iconClass: "oj-ux-ico-contact-group" } },
    ...
    this.appName = ko.observable("INB BANK");
    // user Info used in Global Navigation area

    this.userLogin = ko.observable("shivamkumar.chaurasia@oracle.com");
    // footer
    this.footerLinks = [
